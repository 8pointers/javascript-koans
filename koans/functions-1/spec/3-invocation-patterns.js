...
describe('Invocation patterns', function () {
	...
	it('7 - should understand constructor invocation pattern', function () {
	...
	it('9 - should understand instanceof', function () {
		var Samurai = function (name) {
			this.getName = function () {
				return name;
			};
	...
	it('10 - should understand call-apply invocation pattern', function () {
		var samurai2 = {
			storeThis: storeThis
		}, samurai3 = {};
	...
	it('11 - should understand invocation patterns', function () {
